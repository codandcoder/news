...
$page_headline = trim($_GET['do'] == "edit") ? "HABER DÜZENLE" : "HABER EKLE";
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_box" >
  ...
  <tr>
	...
	<br />
	<br />Devam Etmek Ýstiyor musunuz?<br /><br /><a href="news.php">[ Hayýr ]</a> | <a href="news.php?do=delete&id=<?=$id?>&del_ok=yes">[ Evet ]</a>
	<?php
	}elseif($del == "yes"){
	...
	<a href="news.php">Sayfaya Dönmek Ýçin Týklayýnýz.</a>
	<?php
	}
	?>
	</td>
...
?>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_box" >
    	  ...
    	  <td class="row5px listEven" align="center">
			...
			<a href="news.php">Lütfen Bekleyiniz... Sayfaya Yönlendiriliyorsunuz.</a>
...
<script>
	...
	if(form.cuff_view.value == "Y" && (form.cuff.value == "")){
			alert("Lütfen Manþet Giriniz");
			form.cuff.focus();
			return false;
			}
	
	if(form.spot.value == ""){
			alert("Lütfen Açýklama Giriniz");
			form.spot.focus();
			return false;
			}
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_box" >
  ...
  <tr>
    <td class="row5px listEven"><b>Manþet  :</b></td>
    <td class="row5px listOdd"><input name="cuff" type="text" id="cuff" value="<?=stripslashes($row[cuff])?>" size="70" /> 
    // Manþette gözükecekse doldurun </td>
  </tr>
  <tr>
    <td class="row5px listEven"><b>Manþet Gösterim   :</b></td>
	...
	<label for="cuff_no">Hayýr</label></td>
  </tr>
  <tr>
...
&nbsp; <a href="#"  onclick="javascript:Popup('image.php?do=upload&type=news','',570, 300);">Resim Yükle</a> | <a href="#"  onclick="javascript:Popup('image.php?do=search&type=news','',570, 300);">Resimlerde Ara</a></td>
  </tr>
  <tr>
  ...
  <tr>
    <td valign="top" class="row5px listEven"><b>Haber Ýçeriði  :</b></td>
    <td class="row5px listOdd" >
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_box" >
  ...
  <tr>
	...
	<select name="order_type" id="order_type">
	  <option value="id">-- Seçiniz --</option>
	  ...
	  <option <?php if($order_type=="cuff_view")echo "selected";?> value="cuff_view">Manþet</option>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_box" >
  <tr>
    <td colspan="11" class="listHeader padleft5px" align="center">HABERLER [ <span class="style1"><a href="?do=new" class="yellowlink">YENÝ KAYIT EKLE</a></span> ]</td>
  </tr>
  <tr>
    <td width="5%" class="padleft5px listTitle" align="center">ID</td>
    <td width="12%" class="padleft5px listTitle">Kategori</td>
	<td width="38%" class="padleft5px listTitle">Baþlýk</td>
  ...
  <tr class="<?=$class?>">
	...
	<td class="padleft5px" align="center"><?php if($row[cuff_view]=='Y') echo "<b>Manþet</b>"; else echo "Normal";?></td>
	<td class="padleft5px" align="center"><?php echo active_passive($row[active]);?></td>
	<td class="padleft5px">
	<img src="images/edit.gif" width="17" height="17" align="absmiddle"> <a class="blacklink" href="news.php?do=edit&id=<?=$row[id]?>">Düzenle</a> &nbsp;|&nbsp;
